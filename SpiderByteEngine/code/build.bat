...
set CFiles=..\SpiderByteEngine\code\GLSLAdvanceEngine.cpp ..\SpiderByteEngine\code\glad.c ..\SpiderByteEngine\code\includes\Shader\Shader.cpp ..\SpiderByteEngine\code\includes\Camera\FPSCamera.cpp ..\SpiderByteEngine\code\includes\Model\Model.cpp ..\SpiderByteEngine\code\includes\Mesh\Mesh.cpp
